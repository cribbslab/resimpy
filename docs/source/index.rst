...
The **RE**\ ad **SIM**\ ulation **PY**\ thon program (Resimpy) provides
an scalable interface for users through Python to massively simulate and
generate reads of varying sequencing technologies, in order to avoid
timeconsuming experimental trials and other error-prone approaches.
...
To reproduce the results used in xxx, please follow the instruction
below.
...
The Resimpy documentation showing its usage in different situations are
available at https://resimpy.readthedocs.io/en/latest/index.html.
...
.. |image0| image:: https://img.shields.io/badge/Resimpy-executable-519dd9.svg
.. |image1| image:: https://img.shields.io/badge/last_released-Jan._2022-green.svg
.. |image2| image:: https://img.shields.io/github/stars/cribbslab/resimpy?logo=GitHub&color=blue
.. |image3| image:: https://img.shields.io/pypi/v/resimpyx?logo=PyPI
.. |Documentation Status| image:: https://readthedocs.org/projects/resimpy/badge/?version=latest
   :target: https://resimpy.readthedocs.io/en/latest/?badge=latest
